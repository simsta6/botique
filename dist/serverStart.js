...
exports.starTestServer = exports.startServer = void 0;
...
const startServer = () => {
    ...
    setupServerAfterStart();
};
exports.startServer = startServer;
const starTestServer = () => {
    (0, dotenv_1.config)();
    (0, database_1.connect)();
    setupServerAfterStart();
};
exports.starTestServer = starTestServer;
const setupServerAfterStart = () => {
    ...
    server.patch("/api/items/:id", auth_1.verifyToken, auth_1.verifyIsSeller, (0, auth_1.verifyIsUserHasThisModel)(item_2.Item), item_1.editItem);
    server.delete("/api/items/:id", auth_1.verifyToken, auth_1.verifyIsSeller, (0, auth_1.verifyIsUserHasThisModel)(item_2.Item), item_1.deleteItem);
    // Chart
    ...
    server.patch("/api/orders/:id", auth_1.verifyToken, auth_1.verifyIsSeller, (0, auth_1.verifyIsUserHasThisModel)(order_2.Order), order_1.changeOrderState);
    // User 
